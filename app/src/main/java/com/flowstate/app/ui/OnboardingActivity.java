...
import com.flowstate.app.ui.manual.ManualDataEntryActivity;
...
public class OnboardingActivity extends AppCompatActivity {
    ...
    /**
     * Request permissions for wearable device (Health Connect)
     */
    private void requestWearablePermissions() {
        updateStatus("Checking Health Connect...");
        
        if (hcManager.isAvailable()) {
            // Launch debug activity to handle permissions for now
            Intent intent = new Intent(this, HealthConnectDebugActivity.class);
            startActivity(intent);
            onPermissionsGranted(); // Simulating success for flow
        } else {
    ...
    // Removed legacy Google Fit callback methods
