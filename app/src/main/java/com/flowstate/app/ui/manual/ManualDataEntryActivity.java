package com.flowstate.app.ui.manual;
        ...
        try {
            ...
            executor.execute(() -> {
                try {
                    ...
                    mainHandler.post(() -> {
                        Toast.makeText(this, "Typing test saved!", Toast.LENGTH_SHORT).show();
                        etTypingWpm.setText("");
        ...
        try {
            ...
            executor.execute(() -> {
                try {
                    ...
                    mainHandler.post(() -> {
                        Toast.makeText(this, "Reaction test saved!", Toast.LENGTH_SHORT).show();
