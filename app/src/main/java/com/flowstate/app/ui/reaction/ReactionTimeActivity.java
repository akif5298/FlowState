...
import com.flowstate.app.data.collection.ReactionTimeCollector;
...
public class ReactionTimeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            // Restore state if needed, or just let it reset
        }
    ...
    private void recordReaction() {
        ...
        long reactionTimeNs = endTime - startTime;
        int reactionTimeMs = (int) (reactionTimeNs / 1_000_000); // Convert ns to ms
